        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_deleted_at',
                 models.DateTimeField(null=True, verbose_name='deleted by recipient at', blank=True)),
                ('moderation_status', models.CharField(default='p', max_length=1, verbose_name='status',
                ...
                ('moderation_by',
                 models.ForeignKey(related_name='moderated_messages', verbose_name='moderator', blank=True,
                                   to=settings.AUTH_USER_MODEL, null=True)),
                ('parent', models.ForeignKey(related_name='next_messages', verbose_name='parent message', blank=True,
                                             to='postman.Message', null=True)),
                ('recipient', models.ForeignKey(related_name='received_messages', verbose_name='recipient', blank=True,
                                                to=settings.AUTH_USER_MODEL, null=True)),
                ('sender', models.ForeignKey(related_name='sent_messages', verbose_name='sender', blank=True,
                                             to=settings.AUTH_USER_MODEL, null=True)),
                ('thread', models.ForeignKey(related_name='child_messages', verbose_name='root message', blank=True,
                                             to='postman.Message', null=True)),
            ],
            options={
                'ordering': ['-sent_at', '-id'],
